...
export default function AuthDiscord() {
  useEffect(() => {
    window.location.assign(
      ...
      "https://discord.com/oauth2/authorize?client_id=1394700525148049408&response_type=token&redirect_uri=https%3A%2F%2Fvolt.staffs.es&scope=guilds%20identify%20email&state=discord"
    );
  }, []);
  return null;
}
